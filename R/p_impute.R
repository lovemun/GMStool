#' Imputaion function for missing genotypes
#'
#' p_impute function will impute the missing values in genotype data
#'
#' @param genotype the given genotype data with missing values
#' @return Imputed genotype data
#' @export
