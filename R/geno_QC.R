...
#'
#' geno_QC function will do quality control procedure
#' @param load_data the given load_data list object from load_files function
#' @param maf_cutoff the given decimal point for cut-off of minor allele frequency
#' @param miss_cutoff the given decimal point for cut-off of missing rate
#' @return genotype: genotype after QC
#' @return phenotype: phenotype after QC
#' @export
geno_QC <- function(load_data, maf_cutoff = 0.01, miss_cutoff = 0.01){
  genotype <- load_data$genotype
